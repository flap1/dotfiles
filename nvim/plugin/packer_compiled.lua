...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/flap1/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp-calc", "cmp-cmdline", "cmp-dictionary", "cmp-buffer", "cmp-emoji", "cmp-rg", "cmp-mocword", "cmp-spell", "cmp-tabnine", "cmp-nvim-lua", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-lsp-installer"] = {
    after = { "fidget.nvim", "trouble.nvim", "lspsaga.nvim" },
  ...
  ["tokyonight.nvim"] = {
    after = { "nvim-treesitter", "nvim-web-devicons", "bufferline.nvim", "lualine.nvim", "nvim-cursorword", "nvim-scrollbar", "telescope.nvim" },
  ...
  ["vim-asterisk"] = {
    config = { "\27LJ\2\nV\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0007source ~/.config/nvim/vim/plugins/vim-asterisk.vim\bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["vim-quickhl"] = {
    config = { "\27LJ\2\nU\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0006source ~/.config/nvim/vim/plugins/vim-quickhl.vim\bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["vim-ref"] = {
    config = { "\27LJ\2\nQ\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0002source ~/.config/nvim/vim/plugins/vim-ref.vim\bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["vim-visual-multi"] = {
    config = { "\27LJ\2\nZ\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0;source ~/.config/nvim/vim/plugins/vim-visual-multi.vim\bcmd\bvim\0" },
    loaded = true,
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'Comment.nvim', 'eyeliner.nvim', 'nvim-treesitter', 'nvim-hlslens', 'hop.nvim', 'tokyonight.nvim', 'LuaSnip', 'nvim-autopairs', 'vim-repeat', 'vim-asterisk', 'nvim-colorizer.lua', 'vim-quickhl', 'vim-ref', 'dial.nvim', 'nvim-lspconfig', 'bufdelete.nvim', 'lightspeed.nvim', 'which-key.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
