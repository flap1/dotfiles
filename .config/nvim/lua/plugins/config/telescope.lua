...
-- find ------------------------------------------
vim.keymap.set("n", "[ff]f", "<Cmd>Telescope find_files<CR>", opts)
...
vim.keymap.set("n", "[ff]a", "<Cmd>Telescope find_files follow=true no_ignore=true hidden=true<CR>", opts)
...
vim.keymap.set("n", "[ff]s", "<Cmd>Telescope search_history<CR>", opts)
