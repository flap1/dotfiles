...
vim.keymap.set("n", "<M-9>", "9gt", opts)
vim.keymap.set("n", "<M-J>", "<Cmd>-tabm<CR>", opts)
vim.keymap.set("n", "<M-K>", "<Cmd>+tabm<CR>", opts)
vim.keymap.set("n", "<M-h>", "<Cmd>tabfirst<CR>", opts)
vim.keymap.set("n", "<M-l>", "<Cmd>tablast<CR>", opts)
vim.keymap.set("n", "<M-j>", "<Cmd>tabprevious<CR>", opts)
